  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center h-full w-full px-6 sm:px-10 lg:px-16">
        ...
        >
          <a href="tel:+380688845858" className="flex flex-row items-center gap-2 group cursor-pointer">
          ...
          <a href="tel:+380995669377" className="flex flex-row items-center gap-2 group cursor-pointer">
            <motion.div whileHover={{ rotate: 15, scale: 1.1 }} transition={{ type: "spring", stiffness: 300 }}>
              <TelegramIcon width={28} height={28} />
            </motion.div>
            <span className="text-white text-xl sm:text-2xl lg:text-3xl font-bold tracking-wide 
