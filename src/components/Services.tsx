...
export const Services = () => {
  return (
    <section id="services" className="w-full min-h-screen bg-[var(--main-bg-2)] relative overflow-hidden py-24">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <div className="flex flex-row items-center gap-4 mb-4">
            ...
            <motion.h2
              ...
              transition={{ duration: 0.6, delay: 0.2 }} viewport={{ once: true }}
            >
              Наші <span className="text-[var(--main-green-light)]">послуги</span>
            </motion.h2>
            <motion.div className="h-px w-12 bg-[var(--main-green-muted)]"
              initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }}
              transition={{ duration: 0.6, delay: 0.2 }} viewport={{ once: true }} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            ...
            >
              ...
              {/* Номер картки */}
              <span className="absolute top-4 right-6 text-5xl font-black text-white/5 
              ...
              {/* Стрілка */}
              <div className="mt-6 flex items-center gap-2 text-[var(--main-green-light)] text-sm font-semibold 
